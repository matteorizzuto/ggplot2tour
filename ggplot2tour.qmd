...
from ancient Greek **_γράμμα_**, _letter_. It is a set of rules to combine words and compose statements that make sense in a language
:::
:::
...
A set of rules that, combined, allows us to combine independent components (_layers_) to build meaningful graphics and answer research questions 
:::
:::
:::
...
In Ancient Greek, the word "grammar" has the same root as **_γραφή_**, which means _to draw_ or _to paint_ or _to write_
:::
:::
...
![Sometimes, grammar can mean all three things: write, draw, paint. For instance, in the calligraphic monogram---or _tughra_---of Ottoman Sultan Suleiman I the Magnificent (1494--1566).](images/Tughra_Suleiman.jpeg){fig-align="center"}
...
## ggplot2: quick facts {.incremental .smaller background-image="https://ggplot2.tidyverse.org/logo.png" background-size="200px" background-opacity=0.25}
